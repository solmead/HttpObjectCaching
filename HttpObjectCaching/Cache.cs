...
namespace HttpObjectCaching
{
    ...
    public static class Cache
    {
        ...
        {
            return AsyncHelper.RunSync(()=> GetItemAsync<tt>(area, name, async ()=>createMethod(), lifeSpanSeconds));
        }
        ...
        {
            AsyncHelper.RunSync(() => SetItemAsync<tt>(area, name, obj));
        }
        ...
        {
            AsyncHelper.RunSync(() => SetItemAsync<tt>(area, name, obj, lifeSpanSeconds));
        }
